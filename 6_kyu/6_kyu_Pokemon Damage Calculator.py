...
"""
TASK: Pokemon Damage Calculator
...
(if A is super effective against B, then B is not very effective A).
...
def calculate_damage(your_type, opponent_type, attack, defense):
    if your_type == 'fire' and opponent_type == 'grass':
        ...
        return int(50 * (attack / defense) * 0.5)
...
# Pythonic solution - beautiful, clean code
